...
public class VisitorsDaoImpl {
	...
	public List getAllOrganicDayWiseVisitorRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), SUBSTRING(EXTRACT(YEAR FROM (visit_date)),3), MONTHNAME(visit_date) FROM Visitors visitors WHERE visit_status ='come' GROUP BY visit_date ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	public List getAllOrganicClassDayWiseVisitorRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), SUBSTRING(EXTRACT(YEAR FROM (visit_date)),3), MONTHNAME(visit_date), visit_class FROM Visitors visitors WHERE visit_status ='come' GROUP BY visit_date,visit_class ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	...
	public List getAllOrganicDayWiseVisitorRecord(String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), SUBSTRING(EXTRACT(YEAR FROM (visit_date)),3), MONTHNAME(visit_date) FROM Visitors visitors WHERE visit_status ='come' AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY visit_date ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getCombinedMonthlyVisitorRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' GROUP BY MONTHNAME(visit_date) ORDER BY Date_FORMAT(visit_date,'%m')");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	public List getCombinedMonthlyVisitorRecord(String seatNumber) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), COUNT(visitor_seat_number) FROM Visitors visitors WHERE visitors.visitor_seat_number = :pseatNumber AND visit_status ='come' GROUP BY MONTHNAME(visit_date) ORDER BY Date_FORMAT(visit_date,'%m')");
		query.setParameter("pseatNumber", seatNumber);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getCombinedMonthlyVisitorRecord(String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY MONTHNAME(visit_date) ORDER BY Date_FORMAT(visit_date,'%m')");
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getCombinedMonthlyVisitorRecord(String seatNumber, String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), COUNT(visitor_seat_number) FROM Visitors visitors WHERE visitors.visitor_seat_number = :pseatNumber AND visit_status ='come' AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY MONTHNAME(visit_date) ORDER BY Date_FORMAT(visit_date,'%m')");
		query.setParameter("pseatNumber", seatNumber).setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllOrganicDayWiseVisitorClassRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), MONTHNAME(visit_date), YEAR(visit_date), visitor_class FROM Visitors visitors WHERE visit_status ='come' GROUP BY visit_date, visitor_class ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	public List getAllOrganicDayWiseVisitorStreamRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), MONTHNAME(visit_date), YEAR(visit_date), visitor_stream FROM Visitors visitors WHERE visit_status ='come' GROUP BY visit_date, visitor_stream ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	...
	public List getAllOrganicDayWiseVisitorStreamRecord(String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), MONTHNAME(visit_date), YEAR(visit_date), visitor_stream FROM Visitors visitors WHERE visit_status ='come' AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY visit_date, visitor_stream ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllMonthWiseVisitorClassRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_class, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' GROUP BY MONTHNAME(visit_date),visitor_class ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	public List getAllMonthWiseVisitorClassRecord(String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_class, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY MONTHNAME(visit_date),visitor_class ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllMonthWiseVisitorStreamRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_stream, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' GROUP BY MONTHNAME(visit_date),visitor_stream ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	public List getAllMonthWiseVisitorStreamRecord(String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_stream, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY MONTHNAME(visit_date),visitor_stream ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllMonthWiseVisitorSingleClassRecord(String pclass) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_class, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' AND visitor_class = :pclass GROUP BY MONTHNAME(visit_date) ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		query.setParameter("pclass", pclass);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllOrganicDayWiseVisitorSingleStreamRecord(String pclass,String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), MONTHNAME(visit_date), YEAR(visit_date), visitor_stream FROM Visitors visitors WHERE visit_status ='come' AND visitor_stream = :pclass AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY visit_date, visitor_stream ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		query.setParameter("pclass", pclass).setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllMonthWiseVisitorSingleStreamRecord(String pclass,String datePicker, String datePicker1) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_stream, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' AND visitor_stream = :pclass AND visit_date BETWEEN :pdate1 AND :pdate2 GROUP BY MONTHNAME(visit_date),visitor_stream ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		query.setParameter("pclass", pclass).setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllMonthWiseVisitorSingleStreamRecord(String pclass) {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT MONTHNAME(visit_date), visitor_stream, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' AND visitor_stream = :pclass GROUP BY MONTHNAME(visit_date) ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		query.setParameter("pclass", pclass);
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	...
	public List getAllOrganicDayWiseVisitorClassStreamRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT extract(day from visit_date), COUNT(visitor_seat_number), MONTHNAME(visit_date), YEAR(visit_date), visitor_class, visitor_stream FROM Visitors visitors WHERE visit_status ='come' GROUP BY visit_date,visitor_class,visitor_stream ORDER BY extract(day from visit_date),MONTHNAME(visit_date), YEAR(visit_date)");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	...
	public List getAllMonthWiseVisitorClassStreamRecord() {
		Visitors visitors = new Visitors();
		EntityManager entityManager1 = JPAUtil.getEntityManager1();
		Query query = entityManager1.createQuery("SELECT YEAR(visit_date), MONTHNAME(visit_date), visitor_class,visitor_stream, COUNT(visitor_seat_number) FROM Visitors visitors WHERE visit_status ='come' GROUP BY YEAR(visit_date), MONTHNAME(visit_date),visitor_class,visitor_stream ORDER BY DATE_FORMAT(MONTHNAME(visit_date),'%m')");
		@SuppressWarnings("unchecked")
		List<Visitors> streamList = query.getResultList();
		return streamList;
	}
	...
	public Long getAllVisitorsVisitClassCountMonthwise(String pclass) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' and visitor_class =:pclass group by monthname(visit_date),visitor_class order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pclass", pclass);
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsVisitClassCountMonthwise(String pclass,String datePicker, String datePicker1) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' AND visit_date BETWEEN :pdate1 AND :pdate2 and visitor_class =:pclass group by monthname(visit_date),visitor_class order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pclass", pclass).setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);;
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsVisitStreamCountMonthwise(String pclass) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' and visitor_stream =:pclass group by monthname(visit_date),visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pclass", pclass);
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsVisitStreamCountMonthwise(String pclass,String datePicker, String datePicker1) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' AND visit_date BETWEEN :pdate1 AND :pdate2 and visitor_stream =:pclass group by monthname(visit_date),visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pclass", pclass).setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);;
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsClassCountMonthwise() {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' group by monthname(visit_date),visitor_class order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setMaxResults(1);
		Long count = query.getSingleResult();
		return count;
	...
	public Long getAllVisitorsClassCountMonthwise(String datePicker, String datePicker1) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' AND visit_date BETWEEN :pdate1 AND :pdate2 group by monthname(visit_date),visitor_class order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);;
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsStreamCountMonthwise() {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' group by monthname(visit_date),visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setMaxResults(1);
		Long count = query.getSingleResult();
		return count;
	...
	public Long getAllVisitorsStreamCountMonthwise(String datePicker, String datePicker1) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' AND visit_date BETWEEN :pdate1 AND :pdate2 group by monthname(visit_date),visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);;
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsVisitClassStreamCountMonthwise() {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' group by monthname(visit_date),visitor_class,visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setMaxResults(1);
		Long count = query.getSingleResult();
		return count;
	...
	public Long getAllVisitorsVisitClassStreamCountMonthwise2(String datePicker, String datePicker1) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' AND visit_date BETWEEN :pdate1 AND :pdate2 group by monthname(visit_date),visitor_class,visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);;
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsVisitClassStreamCountMonthwise(String pclass,String pstream) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' and visitor_class =:pclass and visitor_stream = :pstream group by monthname(visit_date),visitor_class,visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pclass", pclass).setParameter("pstream", pstream);
		query.setMaxResults(1);
		Long count = query.getSingleResult();
	...
	public Long getAllVisitorsVisitClassStreamCountMonthwise(String pclass,String pstream,String datePicker, String datePicker1) {
		String qStr = "select count(*) from Visitors visitors where visit_status = 'come' AND visit_date BETWEEN :pdate1 AND :pdate2 and visitor_class =:pclass and visitor_stream = :pstream group by monthname(visit_date),visitor_class,visitor_stream order by count(*) desc";
		TypedQuery<Long> query = entityManager.createQuery(qStr,Long.class);
		query.setParameter("pclass", pclass).setParameter("pstream", pstream).setParameter("pdate1", datePicker).setParameter("pdate2", datePicker1);;
		query.setMaxResults(1);
		Long count = query.getSingleResult();
